...
| `dsh-selfworth` | 585 | `/利益状态` `/利益模式` `/利益账本` | — | — |
...
python3 dsh-selfworth/test_selfworth.py     # 八类占便宜 + 认账形状 + 嘴硬必须放行（含 0913 群语料）
python3 dsh-selfworth/sweep_corpus.py 真话.txt   # 拿真语料 sweep 输出侧，人工看有没有误伤
