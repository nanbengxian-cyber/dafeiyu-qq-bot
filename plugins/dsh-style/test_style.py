...
BAD=[("6","单数字"),("/记住 我叫小明","指令"),("！！！","纯标点"),("👻","纯emoji"),("a","太短"),
     ("https://example.com/x","链接"),("[图片]","占位"),("@群友B 你来","@人"),
...
rows=[("100000001","A","群友A","干嘴",100),("100000001","A","群友A","草",101),
      ("100000001","A","群友A","群友A第二条",102),("100000001","B","群友B","干活呢？发来瞅瞅",103),
      ("100000001","B","群友B","草",104),  # 与 A 的"草"重复，应去重
      ("100000001","C","安","真的假的",105),("100000001","D","zzz","/记住 x",106),
      ("100000001","E","l","👻",107),("100000001","F","群友C","哈哈哈哈",108),
      ("100000001","G","群友D","？我哪天不乖了",109),("999","Z","别群","不该出现",110)]
...
check("B6b 去重保留较新的那条 '草'", [n for n,t in s if t=="草"], ["群友B"])
