...
「大肥鱼经典产生幻觉」，「token」命中了 `tokenhub.example.com` 域名。
...
GLOSSARY: tuple[Entry, ...] = (
    ...
    Entry(("白嫖", "白票"), "不花钱或几乎不花钱拿到资源、服务、奖励。",
          usage=("谁叫你平时不白嫖",)),
    Entry(("元气骑士",), "像素地牢射击手游，群 100000002 的主题。",
          usage=("这里是元气骑士",)),
    ...
    Entry(("病友",), "群名（此处不写，防泄露）来的自嘲互称，不涉及任何真实医疗身份。",
          usage=("群名来源的自称，仓库内不写具体群名",)),
...
def _clean(text: str) -> str:
    """去掉链接。链接里的域名会带来大量假命中（实测 token 命中了 tokenhub.example.com）。"""
